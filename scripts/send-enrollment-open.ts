/**
 * Script to send the enrollment-open announcement to subscribers
 *
 * Usage: npx tsx scripts/send-enrollment-open.ts [options] [emails...]
 *
 * Options:
 ...
 *
 * Examples:
 *   npx tsx scripts/send-enrollment-open.ts --dry-run             # Preview
 *   npx tsx scripts/send-enrollment-open.ts email@x.com           # Specific email
 *   npx tsx scripts/send-enrollment-open.ts                       # Send to ALL subscribers
 */
...
const SUBJECT = "Upisi su službeno otvoreni ✨";
const TEMPLATE_FILE = "enrollment-open.html";
